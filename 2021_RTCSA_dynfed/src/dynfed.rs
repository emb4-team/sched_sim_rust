...
mod tests {
    ...
    fn create_sample_dag() -> Graph<NodeData, i32> {
        ...
        let c1 = dag.add_node(create_node(1, "execution_time", 2));
        let c2 = dag.add_node(create_node(2, "execution_time", 2));

        dag.add_param(c0, "end_to_end_deadline", 100);
        //nY_X is the Yth suc node of cX.
        let n0_0 = dag.add_node(create_node(3, "execution_time", 1));
        let n1_0 = dag.add_node(create_node(4, "execution_time", 1));
